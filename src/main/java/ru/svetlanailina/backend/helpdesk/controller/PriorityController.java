package ru.svetlanailina.backend.helpdesk.controller;

import org.springframework.dao.EmptyResultDataAccessException;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import ru.svetlanailina.backend.helpdesk.entity.Priority;
import ru.svetlanailina.backend.helpdesk.search.PrioritySearchValues;
import ru.svetlanailina.backend.helpdesk.service.PriorityService;
...
public class PriorityController {
    ...
    @PostMapping("/id")
    public ResponseEntity<Optional<Priority>> findById(@RequestBody Long id) {

        Optional<Priority> priority = null;
